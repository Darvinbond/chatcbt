  ...
  <div className="relative w-16 h-16">
    ...
    >
      ...
      <path
        ...
        className="fill-zinc-100 dark:fill-zinc-900/30 stroke-zinc-500 dark:stroke-zinc-400"
        strokeWidth="2"
      >
        <animate
          attributeName="d"
...
export default function FileUpload({
  ...
  return (
    <div
      className={cn("relative w-full max-w-sm dmx-auto", className || "")}
      role="complementary"
      aria-label="File upload"
    >
      <div className="group relative w-full rounded-xl bg-white dark:bg-black ring-1 ring-gray-200 dark:ring-white/10 p-0.5">
        <div className="absolute inset-x-0 -top-px h-px w-full bg-gradient-to-r from-transparent via-zinc-900 to-transparent" />
        ...
        <div className="relative w-full rounded-[10px] bg-gray-50/50 dark:bg-white/[0.02] p-1.5">
          ...
          >
            ...
            >
              <div className="absolute inset-x-0 top-0 h-[20%] bg-gradient-to-b from-zinc-800/20 to-transparent" />
              <div className="absolute inset-x-0 bottom-0 h-[20%] bg-gradient-to-t from-zinc-800/20 to-transparent" />
              <div className="absolute inset-y-0 left-0 w-[20%] bg-gradient-to-r from-zinc-800/20 to-transparent" />
              <div className="absolute inset-y-0 right-0 w-[20%] bg-gradient-to-l from-zinc-800/20 to-transparent" />
              <div className="absolute inset-[20%] bg-zinc-800/10 rounded-lg transition-all duration-300 animate-pulse" />
            </div>

            <div className="absolute -right-4 -top-4 h-8 w-8 bg-gradient-to-br from-zinc-800/20 to-transparent blur-md opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
